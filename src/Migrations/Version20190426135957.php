 ...
 */
final class Version20190426135957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agence (id INT AUTO_INCREMENT NOT NULL, nom_agence VARCHAR(255) NOT NULL, lien_agence VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hotel (id INT AUTO_INCREMENT NOT NULL, nomhotel VARCHAR(255) NOT NULL, positionhotel VARCHAR(255) NOT NULL, typehotel VARCHAR(255) NOT NULL, note VARCHAR(255) NOT NULL, service VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE parametre (id INT AUTO_INCREMENT NOT NULL, nomparametre VARCHAR(255) NOT NULL, typeparametre VARCHAR(255) NOT NULL, valeurparametre VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
