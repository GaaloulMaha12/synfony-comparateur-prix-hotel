 ...
 */
final class Version20190403160451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, pension_id INT DEFAULT NULL, hotel_id INT DEFAULT NULL, nomoffre VARCHAR(255) NOT NULL, datedebut VARCHAR(255) NOT NULL, datefin VARCHAR(255) NOT NULL, INDEX IDX_AF86866F6DB67326 (pension_id), INDEX IDX_AF86866F3243BB18 (hotel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
